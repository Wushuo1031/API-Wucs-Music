export default {
  ...
  login: {
    ...
    notice: `Wucs-Music 承诺不会保存你的任何账号信息到云端。<br />
      你的密码会在本地进行 MD5 加密后再传输到网易云 API。<br />
      Wucs-Music 并非网易云官方网站，输入账号信息前请慎重考虑。 你也可以前往
      <a href="http://music.163.com/playlist?id=419930425&userid=302785585"
        >我的网易云歌单</a
      >
      自行对我的歌单点点收藏`,
    noticeElectron: `你的密码会在本地进行 MD5 加密后再传输到网易云 API。<br />
      Wucs-Music 不会传输你的账号数据到任何非网易云音乐官方的服务器。<br />`,
  },
  mv: {
    moreVideo: '更多视频',
  },
